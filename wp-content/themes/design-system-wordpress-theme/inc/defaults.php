...
if ( ! function_exists( 'cagov_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 * @since 0.1
	 */
	function cagov_get_defaults() {
		return apply_filters(
			'cagov_option_defaults',
			array(
				'hide_title' => '',
				'hide_tagline' => true,
				'logo' => '',
...
if ( ! function_exists( 'cagov_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function cagov_get_color_defaults() {
		return apply_filters(
			'cagov_color_option_defaults',
			array(
...
if ( ! function_exists( 'cagov_get_default_fonts' ) ) {
	/**
	 * Set default options.
	 *
	 * @since 0.1
	 ...
	 */
	function cagov_get_default_fonts( $filter = true ) {
		$defaults = array(
		...
		if ( $filter ) {
			return apply_filters( 'cagov_font_option_defaults', $defaults );
		}
...
if ( ! function_exists( 'cagov_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function cagov_spacing_get_defaults( $filter = true ) {
		$defaults = array(
			'top_bar_top' => '10',
			'top_bar_right' => '40',
			'top_bar_bottom' => '10',
		...
		if ( $filter ) {
			return apply_filters( 'cagov_spacing_option_defaults', $defaults );
		}
...
if ( ! function_exists( 'cagov_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 * @since 1.3.40
	 */
	function cagov_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'cagov_typography_default_fonts', $fonts );
	}
}
