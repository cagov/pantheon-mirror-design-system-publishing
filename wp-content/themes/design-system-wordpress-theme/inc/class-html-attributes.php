...
class GeneratePress_HTML_Attributes {
	...
	public function __construct() {
		add_filter( 'cagov_parse_attr', array( $this, 'parse_attributes' ), 10, 3 );
	}
	...
	public function top_bar( $attributes ) {
		$classes = cagov_get_element_classes( 'top_bar' );
	...
	public function inside_top_bar( $attributes ) {
		...
		if ( 'contained' === cagov_get_option( 'top_bar_inner_width' ) ) {
	...
	public function inside_site_header( $attributes ) {
		$classes = cagov_get_element_classes( 'inside_header' );
	...
	public function primary_navigation( $attributes ) {
		$attributes['class'] .= ' expanded-menu';
	...
	public function primary_inner_navigation( $attributes ) {
		$classes = cagov_get_element_classes( 'inside_navigation' );

		if ( $classes ) {
			$attributes['class'] .= 'expanded-menu-grid';
			$attributes['class'] .= ' ' . join( ' ', $classes );
		}
	...
	public function left_sidebar( $attributes ) {
		$classes = cagov_get_element_classes( 'left_sidebar' );
	...
	public function right_sidebar( $attributes ) {
		$classes = cagov_get_element_classes( 'right_sidebar' );
	...
	public function footer_widgets_container( $attributes ) {
		$classes = cagov_get_element_classes( 'inside_footer' );
